...
The format is simple: one to two weeks, a self-imposed scope, and a production-quality target. The project must be something you can define in a single sentence, small enough to be tractable but real enough to require genuine design decisions. The constraint is the point. There is no grade safety net, no partial credit. Every decision reflects directly on you, and design trade-offs are permanent.
